...
Figura 3 - AIPod Mini Arquitetura de Implantação image:aipod-mini-012.png["300.300"]
...
| OPEA - Intel® AI for Enterprise RAG | 2,0 | Plataforma empresarial RAG baseada em microsserviços OPEA 
...
Figura 5 - Criação de SVM usando ONTAP System Manager. image:aipod-mini-005.png["600.600"] image:aipod-mini-006.png["600.600"]
...
Figura 7 - Criar um bucket S3. image:aipod-mini-008.png["600.600"]
...
Figura 8 - Permissões do bucket S3. image:aipod-mini-009.png["600.600"]
...
Consulte o seguinte documento para obter um fluxo de trabalho de implantação completo e passo a passo: xref:ai-aipod-mini-deployment-steps.html[NetApp AIPod Mini para ERAG - Etapas de implantação]Todos os pré-requisitos, preparação da infraestrutura, parâmetros de configuração e procedimentos de implantação estão documentados no guia de implantação acima.



==== Acesse OPEA para Intel® AI for Enterprise RAG UI

Acesse o OPEA para Intel® AI for Enterprise RAG UI. Consulte o  https://github.com/opea-project/Enterprise-RAG/blob/release-2.0.0/deployment/README.md#interact-with-the-deployed-pipeline["Documentação de deployment do Intel® AI for Enterprise RAG"^] para obter detalhes.
...
Figura 10 - Interface do usuário para ingestão de dados. image:aipod-mini-011.png["600.600"]
...
Consulte o xref:ai-aipod-mini-infra-readiness.html[NetApp AIPod Mini - Prontidão da Infraestrutura] documento para obter mais detalhes.
...
https://github.com/opea-project/Enterprise-RAG/tree/main/docs["Intel® AI ERAG Documentação"]

https://github.com/opea-project/Enterprise-RAG/tree/main/deployment/playbooks["Manual de implantação do OPEA Enterprise RAG"^] == Histórico de versões
