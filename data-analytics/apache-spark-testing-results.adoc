...
summary: Utilizamos os scripts TeraSort e TeraValidate na ferramenta de benchmarking TeraGen para medir a validação do desempenho do Spark com as configurações E5760, E5724 e AFF-A800. 
---
