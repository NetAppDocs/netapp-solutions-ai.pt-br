...
summary: 'NetApp tem três portfólios de storage. FAS e AFF, E-Series e Cloud Volumes ONTAP. Validamos o AFF e o E-Series com o sistema de storage ONTAP para soluções Hadoop com Apache Spark. O data fabric alimentado por NetApp integra serviços e aplicativos de gerenciamento de dados (blocos de construção) para acesso, controle, proteção e segurança de dados.' 
---
