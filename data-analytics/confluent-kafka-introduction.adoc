...
O NetApp instaclustr também oferece suporte ao Kafka com armazenamento em camadas a partir da versão 3.8.1. Confira mais detalhes aqui. link:https://www.instaclustr.com/support/documentation/kafka-add-ons/using-kafka-tiered-storage/["Instaclust usando armazenamento em camadas Kafka"]
