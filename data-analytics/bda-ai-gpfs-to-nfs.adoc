...
summary: Esta seção fornece as etapas detalhadas necessárias para configurar o GPFS e mover dados para o NFS usando o NetApp XCP. 
---
= GPFS para NFS - Etapas detalhadas
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Esta seção fornece as etapas detalhadas necessárias para configurar o GPFS e mover dados para o NFS usando o NetApp XCP.
...
…
....
. Instale o pacote de pré-requisitos (incluindo o chef e os cabeçalhos do kernel) em todos os nós.
+
....
...
....
. Desabilite o SELinux em todos os nós.
+
....
...
[root@mastr-51 installer]#
....
. Adicione o nó de administração e o nó GPFS ao arquivo de definição de cluster.
+
....
...
[root@mastr-51 installer]#
....
. Adicione o nó do gerenciador e o nó GPFS.
+
....
...
....
. Especifique o binário do shell remoto a ser usado pelo GPFS; use `-r argument` .
+
....
...
[root@mastr-51 installer]#
....
. Especifique o binário de cópia de arquivo remoto a ser usado pelo GPFS; use `-rc argument` .
+
....
...
[root@mastr-51 installer]#
....
. Verifique previamente as configurações antes da instalação.
+
....
...
....
. Verifique o status do disco NSD.
+
....
...
Para exportar GPFS para NFS, conclua as seguintes etapas:
...
[root@hdp2 ~]#
....
. Valide a lista de arquivos GPFS na pasta montada no NFS.
+
....
...
[root@hdp2 gpfstest]#
....
. Mova os dados do NFS exportado pelo GPFS para o NetApp NFS usando o XCP.
+
....
